import { TokenPF2e } from "@7h3laughingman/pf2e-types";
 ...
 */
export function measureDistance(p0: Point, p1: Point): number {
    if (canvas.grid.type !== CONST.GRID_TYPES.SQUARE) {
...
/** Get a gride square at an arbitrary point. */
export function squareAtPoint(point: Point): PIXI.Rectangle {
    const snapped =
